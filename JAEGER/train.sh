...
python jaeger_validate.py --csv_file /mnt/disk1/xueying/code/mol-gen/JAEGER/models/training_data/Novartis_and_GDI_7817.csv  --assay_id Novartis_and_GDI_7817